...
Hajde da naučimo na nekoliko načina kako da kreiramo Windows prečice za veb stranice, programe, datoteke, ... . Za video verziju pogledajte [video version](#video-version "Kliknite/tapnite da skoknete na taj odeljak") i šta sam koristio za ovaj tutorijal pogledajte []()

Za ovaj tutorijal sam upotrebio `Windows radnu površinu` za nove prečice, vi koristite bilo koju fasciklu vi želite.

## Povuci i ispusti veb sajt

*(Kliknite na pojedinačni korak ili trougao da bi sakrili ili prikazali detalje (slike, informacije, ...))*

{{< collapse summary="**Korak 1:** Otvorite željenu fasciklu za prečicu i veb pregledač sa otvorenom veb stranicom" openByDefault=true >}}

{{< /collapse >}}

{{< collapse summary="**Korak 2:** Povuci i ispusti..." openByDefault=true >}}
...
## Napravite prečicu iz Start menija

Prvo otvorite željenu fasciklu za prečicu.

*(Kliknite na pojedinačni korak ili trougao da bi sakrili ili prikazali detalje (slike, informacije, ...))*

{{< collapse summary="**Korak 1:** Sa levim dugmetom miša kliknite `Start` dugme" openByDefault=true >}}

   {{< figure src="/images/other/win10/Win10sr_-_start_btn_pocetak.jpeg" title="U Windows 10" >}}
   {{< figure src="/images/other/win11/Win11sr_-_start_btn_start.jpeg" title="U Windows 11" >}}
...
{{< collapse summary="**Korak 2a** Metoda povuci i ispusti" openByDefault=true >}}
	
   Kliknite i držite levo dugme miša na željen element, prevucite ga na željenu lokaciju (meni Start, zakačene aplikacije, traka zadataka, radna površina ili u neku fasciklu), a zatim ispustite dume miša. Sada je prečica napravljena.
...
{{< collapse summary="**Korak 2b** Meni desnog dugmeta miša" openByDefault=true >}}

   Desnim dugmetom miša kliknite element i onda:
...
## Prečice iz Windows upravitelja datoteka

Prvo otvorite željenu fasciklu za prečicu a onda lokaciju elementa za koji želite da napravite prečicu. Takođe možete koristiti jedan prozor upravitelja datoteka za sve ako želite.

*(Kliknite na pojedinačni korak ili trougao da bi sakrili ili prikazali detalje (slike, informacije, ...))*

{{< collapse summary="**Povuci i ispusti** metoda" openByDefault=true >}}

   Levim dugmetom miša kliknite i držite željen elemenat i prevucite ga na željenu lokaciju. Pre nego što ispustite dugme miša proverite, da piše `Kreiraj vezu` u suprotnom kliknite i držite levo `Alt` dugme na tastaturi, prvo ispustite dugme miša a zatim dugme na tastaturi. Time je prečica kreirana.
...
{{< collapse summary="**Meni desnog dugmeta miša** metoda" openByDefault=true >}}
...
## Ručna izrada prečica

*(Kliknite na pojedinačni korak ili trougao da bi sakrili ili prikazali detalje (slike, informacije, ...))*

{{< collapse summary="**Korak 1:** Otvorite željenu fasciklu za prečicu" openByDefault=true >}}
...
{{< collapse summary="**Korak 2:** Kliknite desnim dugmetom miša na prazan prostor željene fascikle, idite na `Nova` a onda kliknite levim dugmetom miša na dugme `Precica`" openByDefault=true >}}
   ...
   - **Adresa veb stranice** mora da sadrži `www.` ili referencu poput `http://`, `https://`, `ftp://`, ... bez barem jedne od njih, na primer `aconetwork.net`. Windows je ne registruje kao adresu veb stranice. dobri primeri: `https://aconetwork.net` ILI `wwww.aconetwork.net`
      
   - **Lokacija datoteke ili fascikle** primer: `C:\Program Files\Google\Chrome\Application\chrome.exe`

   Sada pa idite na `Korak 5`
...
{{< collapse summary="**Korak 4:** Otvorite lokaciju željenog elementa, levim dugmetom miša kliknite na elemenat i onda levim dugmetom miša kliknite na dugme `U redu`." openByDefault=true >}}

   Da biste proširili fascikle sa levim dugmetom miša kliknite na strelice sa leve strane prozora dok ne dođete u željenu lokaciju.
   
   {{< figure src="/images/other/win10/Win10sr_-_kreiranje_precice_-_lokacija_-_potrazi_-_strelica_btn.jpeg" title="Arrows" >}}

   Now left mouse button click on the desired element, example:

   {{< figure src="/images/other/win10/Win10sr_-_kreiranje_precice_-_lokacija_-_potrazi_-_chrome.jpeg" >}}

   To confirm selected left mouse button click on the `OK` button. This will automaticall populate text box in the previous window.

   {{< figure src="/images/other/win10/Win10sr_-_kreiranje_precice_-_lokacija_-_potrazi_-_u_redu_btn.jpeg" >}}

{{< /collapse >}}

{{< collapse summary="**Korak 5:** Sa levim dugmetom miša kliknite dugme `Dalje`" openByDefault=true >}}
   
   {{< figure src="/images/other/win10/Win10sr_-_kreiranje_precice_-_lokacija_-_dalje_btn.jpeg" >}}

{{< /collapse >}}

{{< collapse summary="**Korak 6:** U novom tekstualnom polju unesite željeno ime a onda kliknite levim dugmetom miša na dugme `Završi`, da završite kreiranje prečice." openByDefault=true >}}

   Tekstualno polje je ispod `Otkucajte ime prečice:`.

   {{< figure src="/images/other/win10/Win10sr_-_kreiranje_precice_-_ime_-_zavrsi_btn.jpeg" >}}
